...
import pro.appcraft.lib.utils.common.getColorAttribute
import pro.appcraft.lib.utils.common.getTintAttribute
...
import ru.adchampagne.test.global.ui.activity.BaseActivity
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (savedInstanceState == null) {
            val externalIntentProcessed = processExternalIntent(
                type = intent.getStringExtra(NOTIFICATION_PARAM_TYPE),
                metadata = intent.getStringExtra(NOTIFICATION_PARAM_METADATA),
                fromApp = false
            )
